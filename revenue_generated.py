...
try:
    ...
    print("File not found. Please provide the correct file path and name.")

# 1. Revenue generated by region
...
# 2. Percentage of returning/new customers making a purchase
...
# 3. Sales comparison between weekends and weekdays
...
# 4. Most effective months for generating sales
...
# 5. Contribution of traffic sources to sales
