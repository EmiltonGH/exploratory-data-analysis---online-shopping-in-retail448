...
# 1. Visualize traffic generating most revenue by region
...
# 2. Identify traffic with the highest bounce rate by region
...
# 3. Determine months with the most sales from ads traffic
